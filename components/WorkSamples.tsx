...
import { ExternalLink, Code2, FolderGit2, Github, Globe } from 'lucide-react';
              ...
              <div className="h-full bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 flex flex-col">
                ...
                {sample.links && sample.links.length > 0 && (
                  <div className="mt-4 flex flex-wrap gap-2">
                    {sample.links.map((link, idx) => {
                      const IconComponent =
                        link.icon === 'github' ? Github :
                        link.icon === 'web' ? Globe :
                        link.icon === 'demo' ? ExternalLink :
                        ExternalLink;
                      ...
                      return (
                        <a
                          ...
                          className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg text-sm font-medium transition-all duration-300 shadow-md hover:shadow-lg"
